...
9.1
SELECT COUNT(magyar_szinkron) AS "filmek_szama" FROM filmek
WHERE	magyar_szinkron = 1

9.2
SELECT AVG(hossz_perc) AS "atlagos_hossz" FROM filmek

9.3
SELECT MAX(jegyar) AS "legdragabb_jegyar" FROM filmek

9.4
SELECT AVG(ertekeles) AS "atlagos_ertekeles" FROM filmek
WHERE mufaj = "Sci-fi"

9.5
SELECT SUM(jegyar) AS "osszes_jegyar" FROM filmek
WHERE korhatar = 12

10.1
SELECT cim, hossz_perc, ertekeles FROM filmek
...
10.2
SELECT cim, korhatar, ertekeles, jegyar FROM filmek
WHERE korhatar <= 12
AND magyar_szinkron = 1
AND jegyar <= 2500
ORDER BY ertekeles DESC, jegyar DESC

10.3
SELECT COUNT(*) AS "filmek_szama" FROM filmek
WHERE megjelenes_eve > 2014
AND hossz_perc >= 120
AND ertekeles >= 7.5

10.4
SELECT AVG(jegyar) AS "atlagos_jegyar" FROM filmek
WHERE mufaj IN ("Sci-fi", "Dráma", "Krimi")
AND ertekeles >= 7.5

10.5
SELECT cim, mufaj, megjelenes_eve, hossz_perc, ertekeles, jegyar AS "atlagos_jegyar" FROM filmek
WHERE ertekeles >= 7.8
